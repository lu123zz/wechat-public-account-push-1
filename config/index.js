export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx49877e2e642ef4cb",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "fa008cabb4193140f9b2d3a33d68063d",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "节日", "name": "恋爱日", "year": "2022", "date": "07-27"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "昱昱", "year": "2001", "date": "12-27"},
        {"type": "节日", "name": "相识", "year": "2022", "date": "07-15"},
      ],
      ...
      customizedDateList: [
        ...
        // 第一次见面
        {"keyword": "marry_day", date: "2022-08-23"},
        // 第一次抱抱
        {"keyword": "ex_day", date: "2022-08-23"},
      ]
    },
    {
      name: "宝贝1",
